window.onload = function () {
    ...
    Save.addEventListener("click", () => {
      ...
      console.log("inside a_type", a_type);
      ...
      // console.log('test')
      const data = { a_fname, a_lname, a_city, a_address, a_state, a_country, a_zip, a_phoneNumber, a_addressId , a_type};
      const options = {
        method: "POST",
        headers: {
      ...
      fetch("/add-address", options)
        .then(function (response) {
          ...
          //if(a_type == 'Add'){
            ...
            console.log("inside window--", a_type);
